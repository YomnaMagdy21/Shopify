...
class CategoryProductsAdapter(private val context: Context, var listener: OnCategoryClickListener, private var myProducts: List<Product>) : RecyclerView.Adapter<CategoryProductsAdapter.ViewHolder>() {
